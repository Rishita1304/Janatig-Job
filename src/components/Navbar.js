const Navbar = () => {
    return (
        ...
        <div className="absolute top-[calc(50%_-_27.42px)] left-[calc(50%_-_230px)] md:left-[calc(50%_-_318.5px)] w-[350px] md:w-[636px] flex flex-row items-center justify-between">
          <img
            className="cursor-pointer relative md:w-[57.13px] w-[50px] h-[55.83px] object-cover"
            alt=""
            src="/image-1removebgpreview-1@2x.png"
          />
          <nav className="m-0 flex flex-row items-start justify-start gap-[10px] md:gap-[24px] text-left text-[13px] md:text-base text-black font-kamerik-105">
