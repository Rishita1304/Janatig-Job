  ...
  return (
    <>
      <div className="absolute top-[4824px] left-[0px] bg-darkslategray w-[1440px] h-[442px] overflow-hidden text-13xl text-white">
        ...
        <div className="absolute top-[3.5px] left-[670px] box-border w-px h-[439px] border-r-[1px] border-solid border-dimgray-200" />
        <div className="absolute top-[52px] left-[25px] md:left-[778px] flex flex-col items-start justify-start gap-[20px]">
        ...
        <img
          className="absolute top-[270px] left-[20px] md:left-[763px] w-[119px] h-[116.3px] object-cover"
          alt=""
          src="/image-1removebgpreview-2@2x.png"
        />
        <b className="absolute top-[329px] left-[130px] md:left-[882px]">X.com</b>
      </div>
      <div className="absolute top-[5246px] left-[calc(50%_-_220px)] md:left-[0px] bg-gray w-[450px] md:w-[1440px] h-[58px] overflow-hidden text-xl text-dimgray-100">
        <b className="absolute top-[calc(50%_-_12px)] left-[calc(50%_-_119px)]">
          Made with 🧡 by x.com
        </b>
      </div>
    </>
